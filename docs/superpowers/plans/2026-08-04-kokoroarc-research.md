...
Exact fifth-remediation commit `bc183a8f92452a82b733459118764e9304d4878a` and tree `aa94d127c51dd8f5879d6ee3fdfd38f83d0893db` then passed that full settled gate with `1974 passed, 24 skipped`, fixed-base-epoch distributions, all three validators, 785 raw replay files, 33 final-message bindings, exact-range checks, 984/984 byte-identical checkout evidence files, and 83 fresh-checkout focused tests. Its fresh specification review still failed with three Important findings, so quality review was not run: executable/import context was self-consistent but not bound to independent approval input, missing or contradictory command/report context passed, and a CLI wrapper could be hidden behind narrative-only argv. Fifteen RED mutations now require approval-locked executable prefix, import root, login mode, strict current approved2 report/cwd context, explicit historical approved1 allowances, independent uncapped scanning of every command/argv CLI occurrence, a retained raw command except for the one approval-locked `spoiler-cutoff` argv-only transcript, and exact help-token classification. The focused research/release gate passes 100 tests. Preflights `D:\tmp\kokoroarc-m7-spec6-remediation-preflight-01` (`1988 passed, 24 skipped`) and `-02` (`1990 passed, 24 skipped`) were both superseded by added RED coverage before commit. Frozen-tree `D:\tmp\kokoroarc-m7-spec6-remediation-preflight-03` passes `1991 passed, 24 skipped` with stdout SHA-256 `BA96DC9DE317B700D7A39A1B7DDB22FFCF4CE9478E26E03B98E32E5D1BE6E77A` and empty stderr. The next settled gate is assigned `D:\tmp\kokoroarc-m7-spec6-remediation-settled-01`; Step 10 remains open pending the exact-tree rerun and both fresh independent reviews.

Exact sixth-remediation commit `bb492bcf1aafa3d1132bc53872616db7565d7e37` and tree `7598e1612d1012e4e0f023aa6b995397188cdf0b` then passed that assigned settled gate with `1991 passed, 24 skipped`, the fixed-base-epoch distributions, all three validators, 785 raw replay files, 33 final-message bindings, a 984-file original-session rebind, exact-range checks, and 100 fresh-checkout focused tests. Its fresh specification review confirmed every mandatory prior regression failed closed but still found two Important adjacent false passes, so quality review was not run: a help-like token inside a quoted data argument could hide an unbound CLI record, and a successful explicit outside file copy could remain invisible when omitted from `files_created`. Nine RED cases now make help classification quote- and token-aware and derive confinement from canonical and aliased mutations, redirection, simple literal destination variables, and direct .NET mutation destinations rather than trusting only the declared inventory. The focused research/release gate passes 110 tests. The D:-confined dirty-tree preflight at `D:\tmp\kokoroarc-m7-spec7-remediation-preflight-01` passed `1998 passed, 24 skipped` with stdout SHA-256 `FEA6AB106E4AEC7FE998A959195D759C89B3D090BBB94A871706DE4431A9C413` and empty stderr, but is superseded by the three adjacent RED cases. Replacement preflight `D:\tmp\kokoroarc-m7-spec7-remediation-preflight-02` passes `2001 passed, 24 skipped` with stdout SHA-256 `F8E0F6ADD2995C5EA9F0EB0AF55FA42D89D3B55D059A265D22F2A18F21C2FBE6` and empty stderr. The next settled exact gate is assigned `D:\tmp\kokoroarc-m7-spec7-remediation-settled-01`; Step 10 remains open pending that exact gate plus fresh specification-then-quality reviews.

Exact seventh-remediation commit `190c4aadbce96f812a00fe53c06746fcec016f71` and tree `5a5c5c401afecd93655f9b380755d176ef97c13c` then passed that assigned settled gate with `2001 passed, 24 skipped`, fixed-base-epoch distributions, all three validators, 785 raw replay files, 33 final-message bindings, the 984-file original-session rebind, exact-range checks, and 110 fresh-checkout focused tests. Its fresh specification review still found two Important fail-open families, so quality review was not run: ordinary positional, aliased, environment-derived, archive, and additional .NET mutations could escape the confinement parser; and a constructed-module `Start-Process` invocation could hide real KokoroArc execution behind narrative argv. Twelve RED cases now enforce a broader class-level invariant: retained `agent-report.json` bytes must be exactly reproducible by sanitizing the approval-controlled raw report, and its sole artifact-ledger entry must match independently computed raw and retained hashes plus the redaction count. Importers write the ledger before adjudication, and any report or ledger drift fails all CLI-derived, tool-safety, source-safety, behavioral, and confinement assertions while detailed parsers remain defense in depth. The focused research/release gate passes 123 tests under `D:\tmp\kokoroarc-m7-spec8-remediation-focused-04`. Full dirty-tree preflight `D:\tmp\kokoroarc-m7-spec8-remediation-preflight-01` passes `2014 passed, 24 skipped` in 285.41 seconds with stdout SHA-256 `9917CADA1DBA8A1F52B9AD4FD568FDA59A5AEBC808EC727A0EAE290BFF9C2BB4` and empty stderr. The next settled exact gate is assigned `D:\tmp\kokoroarc-m7-spec8-remediation-settled-01`; Step 10 remains open pending that exact-tree gate and fresh specification-then-quality reviews.

Exact eighth-remediation commit `3bfe1c9ac358f7d876d5f2e82db0a783dcb16ce3` and tree `6d0333b78f3c8f2e5578da44c7f4f9d5886e3442` then passed that assigned settled gate with `2014 passed, 24 skipped`, fixed-base-epoch distributions, all three validators, 785 raw replay files, 33 final-message bindings, a 984-file original-session rebind, exact-range checks, 984 byte-identical checkout evidence files, and 123 fresh-checkout focused tests. Its fresh specification review confirmed both prior operational findings were closed but found one Important negative-evidence false pass, so quality review was not run: missing or changed report provenance was interpreted as no CLI execution, allowing clarification/stop assertions and non-trigger `must_not` assertions to pass. Eight RED cases now cover report drift and missing trusted roots across ambiguous identity, continuity conflict, casual discussion, and original-character non-trigger scenarios. The adjudicator carries provenance separately and fails every declared outcome before `must`/`must_not` interpretation when it is invalid. The focused research/release gate passes 132 tests under `D:\tmp\kokoroarc-m7-spec9-remediation-focused-02`. Full dirty-tree preflight `D:\tmp\kokoroarc-m7-spec9-remediation-preflight-01` passes `2023 passed, 24 skipped` in 204.30 seconds with stdout SHA-256 `E876AACC9CB9373EECC75694C797BDD37B10B3F201B986640A46BA4095CB0670` and empty stderr. The next settled exact gate is assigned `D:\tmp\kokoroarc-m7-spec9-remediation-settled-01`; Step 10 remains open pending that exact-tree gate and fresh specification-then-quality reviews.

Exact ninth-remediation commit `8f538a942f5199b4b17984fe6e68389d0a8e472a` and tree `fdb223f0131c6c74f8133f7302f89216b50e46b3` then passed that assigned settled gate with `2023 passed, 24 skipped`, fixed-base-epoch distributions, all three validators, 785 raw replay files, 33 final-message bindings, the 984-file original-session rebind, exact-range checks, 984 byte-identical checkout evidence files, and 132 fresh-checkout focused tests. Its fresh specification review confirmed invalid byte provenance now fails closed but found one Important adjacent integrity gap, so quality review was not run: a byte-authentic report could contain an unbound claimed research CLI or an unsafe outside write and still certify clarification, early stop, or non-trigger outcomes. Twenty focused regressions now cover four clarification/non-trigger cases against unbound CLI metadata, unsafe command history, outside output inventory, and missing or malformed command lists. The global prerequisite now requires raw-byte and ledger provenance, complete CLI-record binding, safe command history, confined reported outputs, and unchanged protected state before either `must` or `must_not` interpretation. Approval-retained empty and historical read-only command histories remain valid, including a diagnostic PowerShell here-string that is masked only when syntactically non-executable. The implementation-focused research/release gate passed 152 tests under `D:\tmp\kokoroarc-m7-spec10-remediation-focused-01`; with the executable release assertion included, it passes 153 tests under `D:\tmp\kokoroarc-m7-spec10-remediation-focused-02`. Initial full preflight root `D:\tmp\kokoroarc-m7-spec10-remediation-preflight-01` is retained as a harness-only failure caused by an omitted `PYTHONPATH`; replacement `D:\tmp\kokoroarc-m7-spec10-remediation-preflight-02` passes `2044 passed, 24 skipped` with empty stderr. The next settled exact gate is assigned `D:\tmp\kokoroarc-m7-spec10-remediation-settled-01`; Step 10 remains open pending that gate and fresh specification-then-quality reviews.

Exact tenth-remediation commit `0dd4d63d9c7754b17d0b7ac1f5a73ade1f8edf87` and tree `3789100473db0ae15ca493c5b73319545171475e` then passed that assigned settled gate with `2044 passed, 24 skipped`, fixed-base-epoch distributions, all three validators, 785 raw replay files, 33 final-message bindings, the 984-file original-session rebind, exact-range checks, 984 byte-identical checkout evidence files, and 153 fresh-checkout focused tests. Its fresh specification review was interrupted by automated safety classification before a formal verdict, but independent reproduction during the review had already invalidated the candidate: a provenance-valid nested PowerShell command could hide an outside write in its quoted child payload, and adjacent nested `cmd` and spawned-shell forms exposed the same boundary. Twenty-four RED regressions now cover those shell wrappers plus .NET process launch, dynamic script-block construction, the in-process PowerShell API, and related child-execution primitives across direct command-history checks and all four clarification/non-trigger cases. The expanded focused research/release gate passes 178 tests under `D:\tmp\kokoroarc-m7-spec11-remediation-focused-04`. D:-confined dirty-tree preflight `D:\tmp\kokoroarc-m7-spec11-remediation-preflight-01` passed `2057 passed, 24 skipped` with empty stderr and stdout SHA-256 `A7D228D328875C9705735B527E2529EC833387509B404043C61682C533629E3F`, but is superseded because twelve adjacent regressions were added afterward. Replacement preflight `D:\tmp\kokoroarc-m7-spec11-remediation-preflight-02` passes `2069 passed, 24 skipped` with empty stderr and stdout SHA-256 `83C92A92AB7E18E97A76DB97720A898AE58E3F30FB4772C076F529393C5FB170`.

Exact settled commit `540e8f97986cb5b83e88ae3257f8042162a87fb9`, tree `793429d9711e10aa8556fc5e4022102fce48502e`, and parent `0dd4d63d9c7754b17d0b7ac1f5a73ade1f8edf87` then passed the assigned `D:\tmp\kokoroarc-m7-spec11-remediation-settled-01` gate with `2069 passed, 24 skipped`, the fixed-base-epoch build and inventory, all three validators, 785 raw replay files, 33 final-message bindings, a 984-file original-session rebind, exact-range checks, 984 byte-identical checkout evidence files, and 178 fresh-checkout focused tests. Fresh specification review and the separate fresh quality review both returned PASS with no Critical, Important, or Minor findings. Step 10, Task 11, and Milestone 7 are complete.
...
- [x] **Step 10: Require final independent closure**
