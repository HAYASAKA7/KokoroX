...
approve Milestone 9 or the complete standalone suite. A post-closure failure
and its exact passing checkout-policy remediation are disclosed in the
release-verification record; they change neither retained evaluator bytes nor
