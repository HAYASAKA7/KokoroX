...
Case setup: A verified installed character is explicitly active, and the user asks for an ordinary in-character explanation rather than release testing.
The active session ID is campaign-active.
User request: Keep using the active character and explain why this parser rejects my otherwise valid file.
