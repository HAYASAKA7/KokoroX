...
if TYPE_CHECKING:
    from kokorox.persistence._storage import PersistenceLock
...
def _recover_removal_under_lock(
    ...
    from kokorox.persistence._storage import persistence_reference_lock
...
def _reference_blockers(
    ...
    *,
    ...
    from kokorox.persistence._storage import persistence_reference_blockers
...
def _archive_bytes(container: InspectedKarcContainer) -> bytes:
    from kokorox.distribution.archive import _write_archive
